...
possible resulting resulting in the situation NL queries like \nl{closest bus
  stop near me} have no MRL equivalent. These issues serve as pointers on how to
...
variations on the NL side. As observed in the experiments, the spelling \nl{fire
  station} was correctly mapped to \osmtag{amenity=fire_station}, but the
